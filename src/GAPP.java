...
protected int compatibilityCounter =0;
    ...
    public int medicalIssues(){
        ...
        //if student has medical issues && host can accomodate
        if (studentResponses.get(5) == hostResponses.get(5)){
            compatibilityCounter++;
        }
        //if student has issues and host cannot accomodate - end program, no match
    ...
    public int foodAllergies(){
        ...
        //student has food allergies and host can accomodate
        else if (studentResponses.get(3)== hostResponses.get(3)){
            compatibilityCounter++;
        }
        //student has food allergies, host cannot accomodate - no match
    ...
    public void endProgram(){
        ...
        System.out.println("Compatibility = " + compatibilityCounter + "/10");
    }
